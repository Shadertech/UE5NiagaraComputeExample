...
public:
	...
	static void DispatchBoidsDrawerExample_RenderThread(FRDGBuilder& GraphBuilder, const FBoidCurrentParameters& BoidCurrentParameters, FPingPongBuffer& BoidsPingPongBuffer, FRDGTextureUAVRef OutputTextureUAV, UTextureRenderTarget2D* RenderTarget);
	static void DrawToRenderTarget_RenderThread(FRDGBuilder& GraphBuilder,  FRDGTextureSRVRef OutputTexture, UTextureRenderTarget2D* RenderTarget);
};