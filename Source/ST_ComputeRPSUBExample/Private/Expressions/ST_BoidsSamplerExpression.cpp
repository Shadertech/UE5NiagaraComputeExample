...
#include "Expressions/ST_BoidsSamplerExpression.h"
...
const FString PATH_MATERIALEXAMPLELIB = TEXT("/ComputeCore/Private/ComputeRPSUBExample/Libs/MaterialExampleLib.ush");

UST_BoidsSamplerExpression::UST_BoidsSamplerExpression(const FObjectInitializer& ObjectInitializer)
...
#if WITH_EDITOR
int32 UST_BoidsSamplerExpression::Compile( FMaterialCompiler* Compiler, int32 OutputIndex)
{
...
void UST_BoidsSamplerExpression::GetCaption(TArray<FString>& OutCaptions) const
{
